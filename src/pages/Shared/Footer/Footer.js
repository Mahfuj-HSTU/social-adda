    ...
    return (
        <footer className="footer items-center p-4 bg-neutral text-neutral-content mt-10">
            <div className="items-center grid-flow-col">
                ...
                <p>Copyright © Mahfujur Rahman-2022 - All right reserved</p>
            </div>
            <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
                <a href={ 'https://github.com/Mahfuj-HSTU' } target="_blank" rel="noreferrer noopener" className=" text-3xl"><FaGithub /></a>
                <a href={ 'https://www.linkedin.com/in/mahfujur-rahman-24a4a717a/?originalSubdomain=bd' } target="_blank" rel="noreferrer noopener" className=" text-3xl"><FaLinkedinIn /></a>
                <a href={ 'https://www.facebook.com/mahfuj.rahman.18007' } target="_blank" rel="noreferrer noopener" className="text-3xl"><FaFacebook /></a>
            </div>
        </footer>
    );
};
